...
export default {
  ...
  data() {
    return {
      ...
      isEdit: false,
      categoryOptions: [], //下拉列表
      defaultCategoryId: null //默认分类id
    };
  },
  ...
  methods: {
    ...
    getResourceList() {
      ...
      axios.post("/resource/findAllResource", this.listQuery).then(res => {
    ...
    handleUpdate(row) {
      this.dialogVisible = true;
      this.isEdit = true;
      this.resource = Object.assign({}, row); //回显
    },
